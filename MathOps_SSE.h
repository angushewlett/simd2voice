...
public:
	...
	class op_set_f
	{
	public: static vforceinline vec_elem_t op(float a) { return _mm_set1_ps(a); };
	};

	class op_add_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_add_ps(a , b); };
	};

	class op_sub_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_sub_ps(a , b); };
	};

	class op_mul_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_mul_ps(a, b); };
	};

	class op_div_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_div_ps(a, b); };
	};

	class op_min_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_min_ps(a , b); };
	};

	class op_max_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_max_ps(a, b); };
	};

	class op_rcp_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a) { return _mm_rcp_ps(a); };
	};

	class op_abs_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a) { const int32 mask = 0x7FFFFFFF; return  _mm_and_ps(a, _mm_set1_ps(mask)); };
	};

	class op_and_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_and_ps(a, b); };
	};

	class op_or_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_or_ps(a, b); };
	};

	class op_andn_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_andnot_ps(a, b); };
	};

	class op_xor_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_xor_ps(a, b); };
	};

	class op_not_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a) { return _mm_xor_ps(a, _mm_set1_epi32(0xFFFFFFFF)); };
	};

	class op_cmpge_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_cmpge_ps(a,b); };
	};

	class op_cmpgt_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_cmpgt_ps(a,b); };
	};

	class op_cmple_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_cmple_ps(a,b); };
	};

	class op_cmplt_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_cmplt_ps(a,b); };
	};

	class op_cmpeq_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_cmpeq_ps(a,b); };
	};

	class op_cmpne_f
	{
	public: static vforceinline vec_elem_t op(const vec_elem_t& a, const vec_elem_t& b) { return _mm_cmpneq_ps(a,b); };
	};

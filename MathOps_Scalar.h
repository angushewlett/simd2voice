...
////////////////////////////////
// This file provides:-
// * Typedefs for interleaved scalar containers
...
// * General intrinsic-function-style math operations for scalar data ("addps()" etc.) operating on vec_float & vec_int types
...
#define VECPRE4 __declspec(align(4))
#define VECPOST4
#else
#define VECPRE4
#define VECPOST4 __attribute__ ((aligned(4)))
#endif
#undef VECPRE_NATIVE
#undef VECPOST_NATIVE
#define VECPRE_NATIVE VECPRE4
#define VECPOST_NATIVE VECPOST4
...
{
public:
	static const int raw_vec_elem = 1;		// elements in a  vector
	static const int raw_vec_2pow = 0;		// power of 2 for a  vector
	...
	typedef float vec_unaligned_float;
	typedef int32 vec_unaligned_int;
	typedef double vec_unaligned_double;

	typedef VECPRE4 vec_unaligned_float vec_float_t VECPOST4;
	typedef VECPRE4 vec_unaligned_int vec_int_t VECPOST4;
	typedef VECPRE4 vec_unaligned_double vec_double_t VECPOST4;

	union vec { vec_float_t sse; float f[1]; };
...
#pragma unroll(intrlv)
	...
	} VECPOST4;	// End of class vec_float
